...
- `pnpm check:deprecations` — fails CI when `src/`, `examples/`, `scripts/` or the README use an API the AI SDK marks `@deprecated`. `tsc` ignores `@deprecated`, so this class of drift was previously invisible.
